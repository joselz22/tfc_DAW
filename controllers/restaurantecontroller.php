...
class RestauranteController {
    ...
    public function index() {
        ...
        require __DIR__ . '/../views/admin/restaurantes/index.php';
    }
    public function crear() {
        require __DIR__ . '/../views/admin/restaurantes/crear.php';
    }
    ...
    public function editar() {
        ...
        require __DIR__ . '/../views/admin/restaurantes/editar.php';
    }
